...
%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Eddy detection}
\alert{Objective:} Eddy detection from satellite image\\
\alert{Model:} Deep convolutive network
\begin{figure}
\includegraphics[width=.54\textwidth]{./figs/luiz.png}
\end{figure}
\rref[stage Luiz André Schiaveto Neto]
\end{frame}
...
\begin{itemize}
\item<1-> Renforcer les liens entre formations en science de l’environnement  et les formations en Machine Learning
\begin{itemize}
\item Stages pluri-disciplinaires
\end{itemize}
