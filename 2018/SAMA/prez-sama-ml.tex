...
\end{figure}
\begin{itemize}
\item 2014: First scientif paper in neural networks in machine translation.
\item 2016: Neural machine translation outperforme tradiational approaches on public benchmarks
\item 2017: Most of the systems (Google, Systran, WIPO) switch to neural machine translation 
\end{itemize}
\end{frame}
