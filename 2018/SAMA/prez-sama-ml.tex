...
\begin{frame}
  ...
  \begin{columns}
    ...
    \column{.2\textwidth}
    \begin{figure}
      \includegraphics[width=\textwidth]{./figs/logo-saclay.png}
    \end{figure}
  \end{columns}
\pause
  \footnotesize
...
%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Les besoins pour le future}
\begin{itemize}
\item Renforcer les liens entre formations (Master) de l'IPSL et les UFR d'ingénierie.
\item Mieux cibler les grandes questions scientifiques liées à l'apprentissage automatique.
\item Améliorer la visibilité de ce domaine à l'IPSL.
\item Bénéficier d'une infrastructure technique permettant la mise aux point des algorithmes d'apprentissage profond.
\item Structurer la recherche en apprentissage automatique sur les thèmes du climat et des sciences de l'environnement en lien avec d'autres équipes (nationales et internationales).
\end{itemize}
