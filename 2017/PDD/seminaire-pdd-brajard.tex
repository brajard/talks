...
Reference : Goodfellow et al. (2016), Deep Learning, \url{http://www.deeplearningbook.org/}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Example of prediction (1)}
...
%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[t]
\frametitle{Example of prediction (2)}
\framesubtitle{Hidden variables}
Some variables are difficult to observe directly. Can we predict
un-observed variables from related observed variables ?
\vspace{-2em}
\pause
\begin{columns}[t]
\column{.5\textwidth}
\begin{figure}
\includegraphics[width=0.7\textwidth]{./fig/chla-seawifs.png}
\caption{Chlorophyll-a concentration (20 February 2003) by sensor
  SeaWIFS}
\end{figure}
\pause
\column{.5\textwidth}
\begin{figure}
\includegraphics[width=0.7\textwidth]{./fig/fuco-seawifs.png}
\caption{Fucoxanthin concentration ratio (characteristic of the
  phytoplankton group "diatoms") predicted from the chlorophyll-a
  concentration image}
\end{figure}
\end{columns}
%\hfill{\scriptsize\textit{Yala et al. (2016)}}
\rref[Yala et al.(2016)]
\end{frame}
...
\column{.5\textwidth}
\begin{figure}
\includegraphics[width=0.9\textwidth]{./fig/connections.pdf}
\caption{Evolution of connection by neurons for various neural networks}
\end{figure}
\column{.5\textwidth}
\begin{figure}
\includegraphics[width=0.9\textwidth]{./fig/neurons.pdf}
\caption{Evolution of number of neurons for various neural networks}
\end{figure}
\end{columns}
\rref[Goodfellow (2016)]\\
The number of connections and number of neurons are an hyper-parameter
to determin in any neural networks approach.
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{What is a good fit ?}
How to chose the relevant architecture to a given problem ?
\begin{figure}
\includegraphics[width=0.9\textwidth]{./fig/overfitting.pdf}
\end{figure}
\rref[Goodfellow (2016)]
\end{frame}
...
\begin{figure}
\includegraphics[width=0.9\textwidth]{./fig/generalization.pdf}
\end{figure}
\rref[Goodfellow (2016)]\\
\pause
We define a test dataset (independent from the training dataset) to
estimation the generalization error and to determine the optimal
architecture of the neural network.
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Application to the prediction of TSM}
\begin{figure}
...
\caption{Serie temporelle de TSM}
\end{figure}
\pause
\column{.5\textwidth}
\begin{figure}
\includegraphics[width=0.9\textwidth]{./fig/error.png}
\caption{Performance en fonction de l'horizon de pr�vision}
\end{figure}

\rref[Stage de Corentin Vasseur et Zined Elkhlifi]
\end{columns}
\end{frame}
...
\begin{itemize}[<+->]
\item Machine learning approach is well fitted for earth observation data
machine learning good for earth obervation data
\item Despite the maturity of meachine learning, methodologies
  specific to environmental science are still to be found
\item How use the complementary between the knowledge extracted from data
