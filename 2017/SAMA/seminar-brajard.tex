...
\vspace{-3em}
  \begin{figure}
 \begin{center}
 \includegraphics[width=.65\textwidth]{./fig/chart1.png}
\end{center}
 \end{figure}
\vspace{-1em}
\begin{figure}
 \begin{center}
\includegraphics[width=.65\textwidth]{./fig/Euler_LagrangeNew.png}
\end{center}
 \end{figure} 
\column{.5\textwidth}
\begin{onlyenv}<2>
...
forecast the trajectory of a 3rd drifter (not used in the
assimilation).
\end{exampleblock}
\centering
...
\end{onlyenv}
 ...
 \end{columns}
\vspace{1em}
Issa, L., Brajard, J., Fakhri, M., Hayes, D., Mortier,
  L., \& Poulain, P. M. (2016). Modelling surface currents in the
  Eastern Levantine Mediterranean using surface drifters and satellite
  altimetry. Ocean Modelling, 104, 1-14.
\end{frame}
...
\begin{onlyenv}<4->
\begin{itemize}
\item Mixing data based and model based methods
\item Extracting new features from large/multiscale datasets
\item Using machine learning to perform forecast
\end{itemize}
\end{onlyenv}
\end{frame}
