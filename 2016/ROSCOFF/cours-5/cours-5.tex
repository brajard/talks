...
pratical problem : non convex function
theorical problem : it is not the maximum likelihood esimator.
\end{frame}
...
Two cost functions to understand
\end{frame}

\begin{frame}
\frametitle{Logistic cost function}
 \frametitle{A compact definition}

Log of Cross entropy !!!!
